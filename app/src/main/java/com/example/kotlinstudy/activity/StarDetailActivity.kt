...
class StarDetailActivity:BaseActivity() {
    ...
    private fun initView(){
        ...
        //使用行业
        val list1 = arrayListOf<String>("互联网","互联网","互联网","互联网","互联网","互联网","互联网","互联网","互联网","互联网","互联网","互联网","互联网","互联网","互联网","互联网")
        ...
        //产品类型
        val list2 = arrayListOf<String>("肖像图片","形象代言","商家活动","自媒体","肖像图片","形象代言","商家活动","自媒体")
        ...
        val fragmentList = arrayListOf<Fragment>(CommonFragment(),CommonFragment(),CommonFragment(),CommonFragment())
